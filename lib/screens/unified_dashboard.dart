...
// import 'package:emergency_map_sy/features/assignments/screens/responder_assignment_screen.dart';
...
//       if (mounted) {
//         setState(() {
//           _locationError = getLocationErrorMessage(e);
//         });
//       }
//     } finally {
//       if (mounted) {
...
//         child: Container(
//           decoration: BoxDecoration(
//             color: getColorForEmergencyType(
...
//           ),
//           child: Icon(
//             getIconForEmergencyType(_activeAssignment!.state?.emergencyType),
//             color: Colors.white,
//             size: 28,
//           ),
//         ),
...
//                 Text(
//                   'Last updated: ${formatTime(_lastSuccessfulRefresh!)}',
...
//                   height: 40,
//                   decoration: BoxDecoration(
//                     color: getColorForEmergencyType(emergencyType).withValues(alpha: 0.15),
...
//                 padding: const EdgeInsets.all(16),
//                 decoration: BoxDecoration(
//                   color: getColorForEmergencyType(emergencyType).withValues(alpha: 0.05),
...
//         child: Container(
//           decoration: BoxDecoration(
//             color: getUserRoleColor(widget.userType.name),
//             shape: BoxShape.circle,
//             border: Border.all(color: Colors.white, width: 3),
//             boxShadow: [
//               BoxShadow(
...
//             ),
//             child: Icon(
//               getIconForEmergencyType(report.state?.emergencyType),
//               color: Colors.white,
...
//         child: const ResponderAssignmentScreen(),
//       ),
//     ),
//   );
